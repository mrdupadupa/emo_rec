...
var resolution = 512;
//var seed_emo = 23;
//const jsonFilePath = '/home/andrei/Work/emotion_recognition/space-3d/src/seed_data.json';

// Fetch the JSON file using fetch API or XMLHttpRequest
//fetch(jsonFilePath)
//  .then(response => response.json())
//  .then(data => {
//    // Process the JSON data received from the file
//    var seed_emo = data.seed_emo;
//    console.log('Received seed:', seed_emo);

    // Further processing with the seed variable
    // For example, update UI elements with the received seed value
//  })
//  .catch(error => {
